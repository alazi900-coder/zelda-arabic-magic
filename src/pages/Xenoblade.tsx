        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, i) => (
              <div
                key={i}
                className="flex flex-col items-center text-center p-6 rounded-xl bg-card border border-border hover:border-[hsl(200,70%,45%)]/40 transition-colors"
              >
                ...
                <div className="text-sm text-[hsl(180,60%,40%)] font-display font-bold mb-1">
                  الخطوة {i + 1}
                </div>
