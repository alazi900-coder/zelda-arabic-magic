...
export interface DuplicateAlefResult {
  key: string;
  before: string;
  after: string;
  count: number;
...
interface DuplicateAlefCleanPanelProps {
  results: DuplicateAlefResult[];
...
const DuplicateAlefCleanPanel: React.FC<DuplicateAlefCleanPanelProps> = ({
      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display font-bold text-sm">
            🔤 إزالة الألف المكرر — {results.length} نتيجة
...
export default DuplicateAlefCleanPanel;
