...
import type { SentenceSplitResult } from "@/lib/arabic-sentence-splitter";

interface SentenceSplitPanelProps {
  results: SentenceSplitResult[];
...
const SentenceSplitPanel: React.FC<SentenceSplitPanelProps> = ({
      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-display font-bold text-sm">
            ✂️ فصل الجمل المندمجة — {results.length} نتيجة
...
export default SentenceSplitPanel;
